...
class Proxy {
    ...
    _onWebSocketServerConnect(isSSL, ws, upgradeReq) {
        ...
        function makeProxyToServerWebSocket() {
            ctx.proxyToServerWebSocket = new ws_1.default(ctx.proxyToServerWebSocketOptions.url, ctx.proxyToServerWebSocketOptions.protocols, ctx.proxyToServerWebSocketOptions);
